...
" Pyright may not work as expected if can't detect project root correctly.
...
if has('nvim-0.4.0') || has('patch-8.2.0750')
  nnoremap <silent><nowait><expr> <C-j> coc#float#has_scroll() ? coc#float#scroll(1) : "\<Plug>(signify-next-hunk)"
  nnoremap <silent><nowait><expr> <C-k> coc#float#has_scroll() ? coc#float#scroll(0) : "\<Plug>(signify-prev-hunk)"
...
" funa: comment out this line for lualine.
