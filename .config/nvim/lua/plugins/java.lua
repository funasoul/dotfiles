                ...
                java = {
                  configuration = {
                    ...
                    runtimes = {
                      {
                        name = "JavaSE-1.8",
                        path = "/Library/Java/JavaVirtualMachines/openjdk8-zulu/Contents/Home",
                      },
                      {
                        name = "JavaSE-11",
                        path = "/Library/Java/JavaVirtualMachines/openjdk11-zulu/Contents/Home",
                      },
                      {
                        name = "JavaSE-17",
                        path = "/Library/Java/JavaVirtualMachines/openjdk17-zulu/Contents/Home",
                      },
                    },
                  },
                },
