...
case $OSTYPE in
  ...
  darwin21.*)
	...
	;;
  darwin22.*)
	export HOST_TYPE=MacOS_Ventura
	;;
  darwin23.*)
...
path=($HOME/bin{/shell,} $HOME/.local/nvim/bin $HOME/.local/uv/bin $HOME/Dropbox/Sync/bin{/shell,} $HOME/.cargo/bin $HOME/.nimble/bin $HOME/SBW/bin $HOME/android-sdks/platform-tools/ $_path)
unset _path
